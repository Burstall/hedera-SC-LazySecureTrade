...
[`scripts/testing/agentAliasProbe.js`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/scripts/testing/agentAliasProbe.js)
...
And read [`docs/AGENT-RUNTIME-BOOTSTRAP.md`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/docs/AGENT-RUNTIME-BOOTSTRAP.md)
