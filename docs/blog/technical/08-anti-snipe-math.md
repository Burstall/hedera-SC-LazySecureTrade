...
- Tests covering window edge cases are in
  [`test/EnglishAuction.test.js`](https://github.com/Burstall/hedera-SC-LazySecureTrade/blob/v0.3/test/EnglishAuction.test.js).
- The design discussion is in
  [`docs/EnglishAuction-DESIGN.md`](https://github.com/Burstall/hedera-SC-LazySecureTrade/blob/v0.3/docs/EnglishAuction-DESIGN.md)
