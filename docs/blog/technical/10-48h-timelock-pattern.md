...
- The Owner Administration Model is documented in
  [`SECURITY.md`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/SECURITY.md).
- The acceptance tests for the timelock paths are in
  [`test/BidderContractFactory.test.js`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/test/BidderContractFactory.test.js)
