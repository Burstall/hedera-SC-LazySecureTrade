...
- The contract is at
  [`contracts/VIPSubscription.sol`](https://github.com/Burstall/hedera-SC-LazySecureTrade/blob/v0.3/contracts/VIPSubscription.sol).
- The 16-test acceptance suite:
  [`test/VIPSubscription.test.js`](https://github.com/Burstall/hedera-SC-LazySecureTrade/blob/v0.3/test/VIPSubscription.test.js).
- The original design rationale (including the loaner-attack
  discussion):
  [`docs/VIPSubscription-DESIGN.md`](https://github.com/Burstall/hedera-SC-LazySecureTrade/blob/v0.3/docs/VIPSubscription-DESIGN.md).
