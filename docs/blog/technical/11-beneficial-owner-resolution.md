...
- The `_resolveBeneficialOwner` function lives in both
  [`contracts/LazySecureTrade.sol`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/contracts/LazySecureTrade.sol)
  and
...
- The LazyTradeLotto scanner-side cutover (where this matters
  ...
  [`docs/v0.3-OPS-RUNBOOK.md`](https://github.com/lazysuperheroes/hedera-SC-LazySecureTrade/blob/main/docs/v0.3-OPS-RUNBOOK.md)
  §3.
